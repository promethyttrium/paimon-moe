export const banners = {
  ...
  characters: [
    ...
    // },
    {
      ...
      color: '#f8f8f8',
      featured: ['arlecchino', 'zhongli'],
      featuredRare: ['lan_yan', 'rosaria', 'yun_jin'],
      version: '6.1',
    },
    // {
    //   name: 'Gentry of Hermitage',
    ...
    // },
    {
      ...
      color: '#ddeafd',
      featured: ['columbina', 'ineffa'],
      featuredRare: ['fischl', 'sethos', 'ifa'],
      version: '6.3',
      timezoneDependent: true,
    },
    // {
    ...
    // },
    {
      name: 'Harmonious Abundance',
      image: 1,
      shortName: 'Zibai',
      start: '2026-02-03 18:00:00',
      end: '2026-02-24 14:59:00',
      color: '#ddeafd',
      featured: ['zibai', 'neuvillette'],
      featuredRare: ['illuga', 'aino', 'gorou'],
      version: '6.3',
    },
    // {
    //   name: 'Decree of the Deeps',
  ...
  weapons: [
    ...
    },
    {
      ...
      color: '#eae5e1',
      featured: ['crimson_moons_semblance', 'vortex_vanquisher'],
      featuredRare: [
        'the_dockhands_assistant',
        'portable_power_saw',
        'range_gauge',
    ...
    },
    {
      ...
      color: '#ffb169',
      featured: ['nocturnes_curtain_call', 'fractured_halo'],
      featuredRare: [
        'mountain-bracing_bolt',
        'waveriding_whirl',
        'mitternachts_waltz',
  ...
  chronicled: [
    ...
    {
      name: 'Roving Chalice of Dewgrass',
      image: 1,
      shortName: 'Sumeru',
      start: '2025-09-10 06:00:00',
      end: '2025-09-30 17:59:00',
